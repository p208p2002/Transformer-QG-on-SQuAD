...
class GreedyDecoderForMaskedLM():
    ...
    def __call__(self,input_ids,max_length=512):
...
class BeamSearchForMaskedLM():
    def __init__(self, model, tokenizer, beam_size=3, max_token_length=256, stop_token_id=None, device='cpu'):
